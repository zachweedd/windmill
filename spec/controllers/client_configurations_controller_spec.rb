...
RSpec.describe ClientConfigurationsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all configurations as @configurations" do
      ...
      expect(assigns(:configurations)).to eq([configuration])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new configuration as @configuration" do
      ...
      expect(assigns(:configuration)).to be_a_new(Configuration)
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested configuration" do
        configuration = Configuration.create! valid_attributes
        put :update, {:id => configuration.to_param, :configuration => new_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns the configuration as @configuration" do
        configuration = Configuration.create! valid_attributes
        put :update, {:id => configuration.to_param, :configuration => invalid_attributes}, valid_session
        expect(assigns(:configuration)).to eq(configuration)
      end
